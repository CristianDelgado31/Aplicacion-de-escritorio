...
{
    public partial class FormMostrarRegistroActividad : Form
    {
        ...
        public FormMostrarRegistroActividad()
        {
            listaActualizada = new List<USuarioLog>();
            InitializeComponent();
        }
        public FormMostrarRegistroActividad(List<USuarioLog> ListaUsuariosLog, USuarioLog usuarioLog, FormMenuPrincipal formMenuPrincipal) : this()
        {
